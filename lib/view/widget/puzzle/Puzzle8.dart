...
class Puzzle8 extends StatefulWidget {
  const Puzzle8({Key? key}) : super(key: key);

  @override
  _Puzzle8State createState() => _Puzzle8State();
}

class _Puzzle8State extends State<Puzzle8> {
  @override
  void initState() {
    super.initState();
  ...
  List data = [
     {
      "id": 136,
      "solution": "Engineer",
      "question_image": "engineer.gif"
    },
    {
      "id": 137,
      "solution": "Farmer",
      "question_image": "farmer.gif"
    },
    {
      "id": 138,
      "solution": "Firefighter",
      "question_image": "firefighter.gif"
    },
    {
      "id": 139,
      "solution": "Footballman",
      "question_image": "footballman.gif"
    },
    {
      "id": 140,
      "solution": "Doctor",
      "question_image": "doctor.gif"
    }
  ];
