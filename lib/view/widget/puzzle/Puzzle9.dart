...
class Puzzle9 extends StatefulWidget {
  const Puzzle9({Key? key}) : super(key: key);

  @override
  _Puzzle9State createState() => _Puzzle9State();
}

class _Puzzle9State extends State<Puzzle9> {
  @override
  void initState() {
    super.initState();
