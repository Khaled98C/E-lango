...
class Puzzle7 extends StatefulWidget {
  const Puzzle7({Key? key}) : super(key: key);

  @override
  _Puzzle7State createState() => _Puzzle7State();
}

class _Puzzle7State extends State<Puzzle7> {
  @override
  void initState() {
    super.initState();
  ...
  List data = [
   {
      "id": 126,
      "solution": "Teacher",
      "question_image": "teacher.gif"
    },
    {
      "id": 127,
      "solution": "Scientist",
      "question_image": "scientist.gif"
    },
    {
      "id": 128,
      "solution": "Pilot",
      "question_image": "pilot.gif"
    },
    {
      "id": 129,
      "solution": "Reporter",
      "question_image": "reporter.gif"
    },
    {
      "id": 130,
      "solution": "Nurse",
      "question_image": "nurse.gif"
    }
  ];
