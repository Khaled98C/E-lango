...
class Puzzle10 extends StatefulWidget {
  const Puzzle10({Key? key}) : super(key: key);

  @override
  _Puzzle10State createState() => _Puzzle10State();
}

class _Puzzle10State extends State<Puzzle10> {
  @override
  void initState() {
    super.initState();
  ...
  List data = [
    ...
    },
    {
      "id": 147,
      "solution": "Policeman",
      "question_image": "policeman.gif"
    },
    {
      "id": 148,
      "solution": "Rhino",
      "question_image": "rhino.gif"
    },
    {
      "id": 149,
      "solution": "Zibra",
      "question_image": "zibra.gif"
    },
    {
      "id": 150,
      "solution": "Mechanic",
      "question_image": "mechanic.gif"
    }
  ];
