...
class NumberMapQuestion extends StatelessWidget {
  const NumberMapQuestion({
    Key? key,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    ControllerMapquetsion controller = Get.find();
    return GetBuilder<ControllerMapquetsion>(
            ...
            itemBuilder: (context, index) {
              return InkWell(
                  onTap: () {
                    ...
                    controller.GotoLevelGame((index + 30).toString());
                  },
                  child: Hero(
                      tag: index,
                      child: Padding(
